CREATE PROC SP_UTL_SET_REFRESH_ZCONSTANTES
AS 
BEGIN 
...
/*PREENCHE TABELA */
INSERT INTO @TAB 
SELECT DISTINCT TABELA, CAMPO, TABELA_DINAM, CAMPO_DINAM, GDINAM_CODIGO, GDINAM_APLICACAO
FROM DBO.ZCONSTANTES
WHERE TABELA_DINAM IS NOT NULL 
...
JOIN DBO.ZCONSTANTES Z 
	ON ( T.TABELA = Z.TABELA AND T.CAMPO = Z.CAMPO 
	  AND T.TABELA_DINAM = Z.TABELA_DINAM AND T.CAMPO_DINAM = Z.CAMPO_DINAM)
